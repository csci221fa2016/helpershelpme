...
.form {background: rgba(28, 62, 88, 0.9);padding: 40px;max-width: 600px;margin: 100px auto;border-radius: 4px;box-shadow: 0 4px 10px 4px rgba(19, 35, 47, 0.3);}\
...
input, textarea {-size: 22px;margin-bottom: 20px;display: block;width: 100%;height: 45px;padding: 5px 10px;background: none;background-image: none;border: 1px solid #a0b3b0;color: #ffffff;border-radius: 0;-webkit-transition: border-color .25s ease, box-shadow .25s ease;transition: border-color .25s ease, box-shadow .25s ease;}\
