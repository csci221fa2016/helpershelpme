...
//LOGIN AND SIGN UP <============DO NOT TOUCH====================>
...
.tab-group li a:hover {background: #179b77;color: #ffffff;}\
.tab-group .active a {background: #1ab188;color: #ffffff;}\
.tab-content > div:last-child {display: none;}\
h1 {text-align: center;color: #ffffff;font-weight: 300;margin: 0 0 40px;}\
label {position: absolute;-webkit-transform: translateY(6px);transform: translateY(6px);left: 13px;color: rgba(255, 255, 255, 0.5);-webkit-transition: all 0.25s ease;transition: all 0.25s ease;-webkit-backface-visibility: hidden;pointer-events: none;font-size: 22px;}\
...
input, textarea {-size: 22px;display: block;width: 100%;height: 45px;padding: 5px 10px;background: none;background-image: none;border: 1px solid #a0b3b0;color: #ffffff;border-radius: 0;-webkit-transition: border-color .25s ease, box-shadow .25s ease;transition: border-color .25s ease, box-shadow .25s ease;}\
...
.button {border: 0;outline: none;border-radius: 0;    margin-top: 40px;padding:0;font-size: 2rem;font-weight: 600;text-transform: uppercase;letter-spacing: .1em;background: #1ab188;color: #ffffff;-webkit-transition: all 0.5s ease;transition: all 0.5s ease;-webkit-appearance: none;}\
